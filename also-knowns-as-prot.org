...
(defvar osama-vault "~/osama-vault/emacs/"
...
(when (eq system-type 'windows-nt)
  ;; Define tools directory using osama-vault variable
  (let ((tools-dir (expand-file-name "data/tools/" osama-vault)))
...
;; Define the folder to save fonts directly inside osama-vault
(defvar osama-icons-dir
  (expand-file-name "data/fonts/" osama-vault)
...
(dolist (sub '("savehist" "recentf" "desktop" "backups" "autosaves"))
  (let ((dir (expand-file-name (concat "cache/" sub "/") osama-vault)))
    (unless (file-directory-p dir)
      (make-directory dir t))))

;; Savehist: command history
(setq savehist-file (expand-file-name "cache/savehist/savehist" osama-vault))
(savehist-mode 1)

;; Recentf: recent files list
(setq recentf-save-file (expand-file-name "cache/recentf/recentf" osama-vault))
(recentf-mode 1)

;; Desktop: full session restore
(setq desktop-path    (list (expand-file-name "cache/desktop/" osama-vault))
      desktop-dirname (expand-file-name "cache/desktop/" osama-vault)
      desktop-base-file-name "emacs-desktop")
(desktop-save-mode 1)

;; Backups: store ~ files in backups/
(setq backup-directory-alist
      `((".*" . ,(expand-file-name "cache/backups/" osama-vault)))
      backup-by-copying t
      version-control t
...
(setq auto-save-file-name-transforms
      `((".*" ,(expand-file-name "cache/autosaves/" osama-vault) t))
      auto-save-default t
...
اكتب =intl.cpl=
واختر
Administrative > Change system local... > Arabic (Saudi Arabia)
...
(use-package org
  ...
  (("C-c o a a" . org-agenda)
   ("C-c o a t" . org-set-tags-command))
  :config
  (setq org-log-done 'time)
  (setq org-log-into-drawer t)
  (setq org-agenda-files
      (directory-files-recursively "~/osama-vault/emacs/org/agenda" "\\.org$"))
...
#+BEGIN_SRC powershell :tangle nil
