...
** The =init.el= settings for System-specific settings
...
#+begin_src emacs-lisp :tangle "~/.emacs.d/osama-emacs-android.el" :mkdirp yes
...
#+begin_src emacs-lisp :tangle "~/.emacs.d/osama-emacs-windows.el" :mkdirp yes
