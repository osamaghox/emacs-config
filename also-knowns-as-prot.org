...
(when (eq system-type 'windows-nt)
  ...
  (let ((tools-dir (expand-file-name "~/osama-vault/emacs/data/tools/")))
...
*** The =osama-emacs-theme.el= section for ~ef-themes~
...
*** [Disabled] The =osama-emacs-theme.el= section for modeline
...
*** The =osama-emacs-theme.el= section for ~doom-themes~
...
*** The =osama-emacs-theme.el= section for ~doom-modeline~
...
;; Define the folder to save fonts directly inside ~/osama-vault/emacs/data/fonts
(defvar osama-icons-dir
  (expand-file-name "~/osama-vault/emacs/data/fonts/")
...
(defvar osama-fonts-dir (expand-file-name "~/osama-vault/emacs/data/fonts/")
...
(defvar osama-cache-dir
  (expand-file-name "~/osama-vault/emacs/cache/")
...
(use-package org
  ...
  :init
  ;; Org files directory
  (setq org-directory (expand-file-name "~/osama-vault/emacs/org/"))
  ;; Depth for imenu
...
(use-package org
  ...
  (setq org-directory "~/osama-vault/emacs/org/agenda/")
...
(use-package denote
  ...
  :config
  (setq denote-directory (expand-file-name "~/osama-vault/emacs/notes/"))
...
*** The =osama-emacs-dired.el= settings for hide toggle files extension

#+begin_src emacs-lisp :tangle "modules/osama-emacs-dired.el" :mkdirp yes
(defvar-local osama-dired-hide-extensions-enabled nil
  "Non-nil if file extensions are hidden in this Dired buffer.")

(defun osama-dired--apply-hide-extensions (hide)
...
(defun osama-dired-toggle-hide-extensions ()
  "Toggle hiding of ALL file extensions in current Dired buffer."
  (interactive)
  (setq osama-dired-hide-extensions-enabled
        (not osama-dired-hide-extensions-enabled))
  (osama-dired--apply-hide-extensions osama-dired-hide-extensions-enabled)
  (message "Dired: %s extensions"
           (if osama-dired-hide-extensions-enabled "hiding" "showing")))

(global-set-key (kbd "C-c d t") #'osama-dired-toggle-hide-extensions)
#+end_src
