...
* The Core Settings of My Emacs Configuration

This module load basic configurations that apply to most facets of Emacs.

** The =osama-emacs-core.el= Section for UI Basics

#+begin_src emacs-lisp :tangle "modules/osama-emacs-core.el" :mkdirp yes
;; Visible bell
(setq visible-bell t)
...
** The =osama-emacs-core.el= Section for Support Arabic Filenames
