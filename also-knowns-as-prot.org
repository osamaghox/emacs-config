...
(setq org-capture-templates
      `(
        ...
        ("tt" "Task" entry
         ...
         "* TODO %?\n  %U\n  %a\n  %i"
         :empty-lines 1
         :prepend t)  ;; يضيف المهمة في أعلى الملف
        ...
        ("mw" "Weight" table-line
         (file+headline ,(expand-file-name "org/Metrics.org" osama-emacs-home-dir) "Weight")
         "| %U | %^{Weight} | %^{Notes} |"
         :kill-buffer t)
        )))
#+end_src

*** The =osama-emacs-org.el= section for ~org-habit~
...
(use-package org
  ...
  ;; مجلد الملفات
  (setq org-agenda-files `(,(expand-file-name "org" osama-emacs-home-dir)))
