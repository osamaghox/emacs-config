...
** The =osama-emacs-voltaic.el= module

#+begin_src emacs-lisp :tangle "~/.emacs.d/modules/osama-emacs-voltaic.el" :mkdirp yes
(use-package org
  :ensure nil
  :bind
  :config
(setq org-agenda-files
      (list
       (expand-file-name "org/voltaic/Voltaic_Routine.org" osama-emacs-home-dir)
