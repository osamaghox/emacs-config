...
نخلي اي حاجة تعديل او اختصار بمفرده في editing.el

با نسوي ملف موديل جديد بيحتوي على الاشياء الثانوية الغير اساسية في النظام
...
(load (expand-file-name "modules/osama-emacs-core.el" user-emacs-directory))
(load (expand-file-name "modules/osama-emacs-editing.el" user-emacs-directory)) ;; Evil needs to load early often

;; Load Appearance
(load (expand-file-name "modules/osama-emacs-ui-appearance.el" user-emacs-directory))

;; Load Features
(load (expand-file-name "modules/osama-emacs-completion.el" user-emacs-directory))
(load (expand-file-name "modules/osama-emacs-org.el" user-emacs-directory))
(load (expand-file-name "modules/osama-emacs-denote.el" user-emacs-directory))
(load (expand-file-name "modules/osama-emacs-dired.el" user-emacs-directory))
...
*** The =osama-emacs-ui-appearance.el= section for ~doom-plain-theme~
...
#+begin_src emacs-lisp :tangle "~/.emacs.d/modules/osama-emacs-core.el" :mkdirp yes
  ...
  ;;settings for dired-hide-details-mode
  (use-package dired
    :ensure nil
...
*** The =osama-emacs-core.el= Section for Paragraph Text Direction
...
*** The =osama-emacs-core.el= settings for ~text-mode~
...
*** The =osama-emacs-core.el= section for ~undo-tree~ package
...
*** The =osama-emacs-core.el= section for Markdown Basic Settings
