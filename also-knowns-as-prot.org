...
(use-package denote
  ...
  :bind
  (("C-c c n b" . denote-find-backlink)
   ("C-c c n d" . denote-date)
   ("C-c c n l" . denote-find-link)
   ("C-c c n i" . denote-link-or-create)
   ("C-c c n k" . denote-rename-file-keywords)
   ("C-c c n n" . denote)
   ("C-c c n r" . denote-rename-file)
   ("C-c c d R" . denote-rename-file-using-front-matter)))
