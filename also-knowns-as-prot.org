...
(defvar osama-emacs "~/osama-vault/emacs/"
...
(when (eq system-type 'windows-nt)
  ;; Define tools directory using osama-emacs variable
  (let ((tools-dir (expand-file-name "data/tools/" osama-emacs)))
...
;; Define the folder to save fonts directly inside osama-emacs
(defvar osama-icons-dir
  (expand-file-name "data/fonts/" osama-emacs)
...
(dolist (sub '("savehist" "recentf" "desktop" "backups" "autosaves"))
  (let ((dir (expand-file-name (concat "cache/" sub "/") osama-emacs)))
    (unless (file-directory-p dir)
      (make-directory dir t))))

;; Savehist: command history
(setq savehist-file (expand-file-name "cache/savehist/savehist" osama-emacs))
(savehist-mode 1)

;; Recentf: recent files list
(setq recentf-save-file (expand-file-name "cache/recentf/recentf" osama-emacs))
(recentf-mode 1)

;; Desktop: full session restore
(setq desktop-path    (list (expand-file-name "cache/desktop/" osama-emacs))
      desktop-dirname (expand-file-name "cache/desktop/" osama-emacs)
      desktop-base-file-name "emacs-desktop")
(desktop-save-mode 1)

;; Backups: store ~ files in backups/
(setq backup-directory-alist
      `((".*" . ,(expand-file-name "cache/backups/" osama-emacs)))
      backup-by-copying t
      version-control t
...
(setq auto-save-file-name-transforms
      `((".*" ,(expand-file-name "cache/autosaves/" osama-emacs) t))
      auto-save-default t
...
(use-package org
  ...
  :init
  ;; Org files directory
  (setq org-directory (expand-file-name "org/" osama-emacs))
  ;; Depth for imenu
...
(use-package org
  ...
  (setq org-agenda-files
      (directory-files-recursively
       (expand-file-name "org/agenda" osama-emacs)
       "\\.org$"))
...
(use-package denote
  ...
  :config
  (setq denote-directory (expand-file-name "notes/" osama-emacs))
