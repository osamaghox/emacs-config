...
;; Nerd Font only for symbols
(when (member "Symbols Nerd Font Mono" (font-family-list))
  ;; نحدد فقط رموز معينة بدل 'unicode الكامل
  (dolist (charset '(symbol dingbats))
    (set-fontset-font t charset (font-spec :family "Symbols Nerd Font Mono"))))
...
(defun open-emacs-config ()
  ...
  :bind
  (("C-c e q" . kill-emacs)       ;; Quit Emacs with confirmation
...
(use-package dashboard
  ...
  (setq dashboard-startup-banner
        (expand-file-name "data/osama-emacs-banner.svg" osama-emacs-home-dir))
  (setq dashboard-banner-logo-title "“The things you own end up owning you.”")

  ;; Remove all default dashboard items
  (setq dashboard-items nil)

  ;; Custom commands (displayed under the banner)
  (setq dashboard-set-init-info t)
  (setq dashboard-show-icons t)
