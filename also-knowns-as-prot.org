...
*** [Disabled] The =osama-emacs-appearance.el= section for ~doom-plain-theme~
...
(use-package doom-themes
  ...
  ;; تعديل لون النص المحدد فقط (region)
  (custom-set-faces
...
;; Arabic Font
(when (member "Noto Kufi Arabic" (font-family-list))
(set-fontset-font t 'arabic (font-spec :family "Noto Kufi Arabic")))
