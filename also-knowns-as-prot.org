...
*** The =osama-emacs-essentials.el= Section for Support Arabic Typing & Arabic Filenames
...
(use-package denote
  :defer t
  :custom
  ;; Sort keywords automatically when creating notes
  (denote-sort-keywords t)
  ;; Use Title Case for link descriptions
  (denote-link-description-function #'osama-denote-link-description-title-case)
  ;; Automatically rename buffer when saving
  (denote-rename-buffer-mode 1)
  :hook
  ;; Enable denote mode when opening dired
  (dired-mode . denote-dired-mode)
  :custom-face
  ;; Style for Denote links
...
;;; Fixed by Prot: Title Case link description
(defun osama-denote-link-description-title-case (file)
