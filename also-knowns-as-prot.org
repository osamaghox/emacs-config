...
(use-package doom-themes
  :bind (("C-c t t" . osama-emacs-toggle-doom-plain-theme))
  :config
  (load-theme 'doom-plain-dark t)

  (defun osama-emacs-toggle-doom-plain-theme ()
    "Toggle between `doom-plain` and `doom-plain-dark`."
    (interactive)
    (cond
     ;; لو الحالي doom-plain → بدّل لـ doom-plain-dark
     ((member 'doom-plain custom-enabled-themes)
      (disable-theme 'doom-plain)
      (load-theme 'doom-plain-dark t))
     ;; لو الحالي doom-plain-dark → بدّل لـ doom-plain
     ((member 'doom-plain-dark custom-enabled-themes)
      (disable-theme 'doom-plain-dark)
      (load-theme 'doom-plain t))
     ;; لو ولا واحد شغال → اختر الافتراضي doom-plain
     (t
      (load-theme 'doom-plain t)))))
#+end_src
