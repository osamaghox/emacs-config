...
#+begin_src emacs-lisp :tangle "init.el" :mkdirp yes
(defvar osama-emacs-dot-dir (expand-file-name "~/.emacs.d/")
  "The root dir of the Osama Emacs distribution.")

(defvar osama-emacs-modules-dir (expand-file-name "modules" osama-emacs-dot-dir)
...
(dolist (sub '("savehist" "recentf" "desktop" "backups" "autosaves"))
  (let ((dir (expand-file-name (concat "cache/" sub "/") osama-emacs-home-dir)))
    (unless (file-directory-p dir)
      (make-directory dir t))))

;; Savehist: command history
(setq savehist-file (expand-file-name "cache/savehist/savehist" osama-emacs-home-dir))
(savehist-mode 1)

;; Recentf: recent files list
(setq recentf-save-file (expand-file-name "cache/recentf/recentf" osama-emacs-home-dir))
(recentf-mode 1)

;; Desktop: full session restore
(setq desktop-path    (list (expand-file-name "cache/desktop/" osama-emacs-home-dir))
      desktop-dirname (expand-file-name "cache/desktop/" osama-emacs-home-dir)
      desktop-base-file-name "emacs-desktop")
(desktop-save-mode 1)

;; Backups: store ~ files in backups/
(setq backup-directory-alist
      `((".*" . ,(expand-file-name "cache/backups/" osama-emacs-home-dir)))
      backup-by-copying t
      version-control t
...
(setq auto-save-file-name-transforms
      `((".*" ,(expand-file-name "cache/autosaves/" osama-emacs-home-dir) t))
      auto-save-default t
...
(use-package org
  ...
  (setq org-agenda-files
      (directory-files-recursively
       (expand-file-name "org/agenda" osama-emacs-home-dir)
       "\\.org$"))
