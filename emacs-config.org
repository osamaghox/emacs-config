...
mkdir -p /sdcard/osama-vault/fonts
...
ln -s /sdcard/osama-vault/fonts /data/data/org.gnu.emacs/files/fonts
#+END_EXAMPLE
...
(defvar osama-emacs-home-dir "~/osama-vault/"
...
(use-package emacs
  ...
  (defun open-emacs-config ()
    ...
    (interactive)
    (find-file (expand-file-name "emacs/emacs-config.org" osama-emacs-home-dir)))
...
*** The =osama-emacs-core.el= Section for Commands Menu
...
(add-to-list 'custom-theme-load-path
             (expand-file-name "emacs/themes/" osama-emacs-home-dir))
#+end_src
...
(use-package moody
  ...
  (setq-default mode-line-format
                '("%e"
                  ...
                  mode-line-modes
                  mode-line-misc-info
                  ;; Input Method في أقصى اليمين
                  (:eval
                   (propertize
                    (if current-input-method
                        (if (string-match-p "arabic" current-input-method)
                            " AR "
                          " EN ")
                      " EN ")
                    'face 'mode-line))
...
(use-package emacs
  ...
  (defvar osama-icons-dir
    (expand-file-name "fonts/" osama-emacs-home-dir)
...
*** The =osama-emacs-ui.el= setction for ~pulsar~
...
(use-package eglot
  ...
  :hook ((c-mode c++-mode objc-mode
          css-mode js-mode js2-mode json-mode typescript-mode nix-mode) . eglot-ensure)
...
(use-package yasnippet
  ...
  (add-to-list 'yas-snippet-dirs
               (expand-file-name "emacs/snippets/" osama-emacs-home-dir))
  (yas-global-mode 1))
...
*** The =osama-emacs-dev.el= settings for ~nix-mode~
