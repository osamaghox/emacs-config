...
(use-package treemacs
  ...
  :defer t
  :init
  ;; (Requirement 1) جعل النافذة تظهر دائماً في الجهة اليسرى
  (setq treemacs-position 'left)
  :config
  (setq treemacs-width 30) ; يمكنك تعديل العرض حسب رغبتك

  ;; (Requirement 3) إضافة مجلدك الخاص تلقائياً إلى مساحة العمل
  ;; نتأكد أولاً أن المتغير معرف والمجلد موجود لتجنب الأخطاء
  ...
  ;; جعل المؤشر يتبع الملف المفتوح (اختياري ولكنه مفيد)
...
(use-package hide-mode-line
  :ensure t
  :hook
  ;; (Requirement 2) تفعيل الإخفاء عند فتح Treemacs فقط
