...
(use-package transient
  ...
  (transient-define-prefix osama-web-dispatch ()
    ...
    ["Web Server"
     ("s" "Serve Directory" (lambda () (interactive) (call-interactively 'httpd-serve-directory) (message "🚀 Serving Directory")) :transient t)
     ("k" "Stop Server"     (lambda () (interactive) (httpd-stop) (message "🛑 Server Stopped")) :transient t)
     ("p" "Port Settings"   (lambda () (interactive) (customize-variable 'httpd-port) (message "⚙️ Adjusting httpd-port")) :transient t)]
    
    ["Live Preview"
     ("i" "Impatient Mode"  (lambda () (interactive) (impatient-mode) (message "👀 Impatient Mode toggled")) :transient t)
     ("o" "Open Browser"    (lambda () (interactive) (browse-url (format "http://localhost:%d/imp/" httpd-port)) 
                                      (message "🌐 Browser opened")) :transient t)]))
#+end_src
