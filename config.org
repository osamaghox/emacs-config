...
*** The =osama-emacs-appearance.el= section for Windows

#+begin_src emacs-lisp :tangle "~/.emacs.d/modules/osama-emacs-appearance.el"
(use-package emacs
  :ensure nil
  :bind
...
*** The =osama-emacs-appearance.el= settings for ~dashboard~
...
*** The =osama-emacs-appearance.el= section for ~tab-bar-mode~
