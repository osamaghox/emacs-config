...
- [ ] add (lexical-binding) to every el file of this config 
- [ ] remove the all mkdirp from org tangle except for first code in the module  
...
*** The =init.el= Footer Section

#+begin_src emacs-lisp :tangle "~/.emacs.d/modules/init.el.el"
;;; init.el ends here
#+end_src
...
*** The =osama-emacs-core.el= Footer Section
#+begin_src emacs-lisp :tangle "~/.emacs.d/modules/osama-emacs-core.el" :mkdirp yes
...
*** The =osama-emacs-ui.el= Footer Section
...
*** The =osama-emacs-editing.el= Footer Section
...
*** The =osama-emacs-completion.el= Footer Section
...
*** The =osama-emacs-dev.el= Footer Section
...
(use-package org
  :init
  ;; Change document title size using custom-set-faces, which is fine here
  (custom-set-faces
   '(org-document-title ((t (:height 2.0 :underline nil)))))

  :config
  ;; Replace dashes with bullets using font-lock-add-keywords
...
*** The =osama-emacs-org.el= Footer Section
...
*** The =osama-emacs-denote.el= Footer Section
...
*** The =osama-emacs-android.el= Footer Section
...
*** The =osama-emacs-windows.el= Footer Section
